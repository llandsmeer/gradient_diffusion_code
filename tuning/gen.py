...
class Params:
    ...
    default = dict(
        g_CaL   =   0.003,  g_h     =   0.025,  g_K_Ca  =   0.250,  g_ld    =   1.3e-5,
        g_la    =   1.3e-5, g_ls    =   1.3e-5, g_Na_s  =   0.030,  g_Kdr_s =   0.040,
        g_K_s   =   0.020,  g_CaH   =   0.160,  g_Na_a  =   0.250,  g_K_a   =   0.250,
...
with open(f'tgt.pkl', 'rb') as f:
    data = pickle.load(f)
    plt.plot(data['v'][:,1], color='red')
plt.plot(v)
plt.show()

with open(f'tgtv2.pkl', 'wb') as f:
    pickle.dump(out, f)
